...
import { updateMunicipio, type FormActionState } from "@/lib/actions/territorio";
...
export function EditMunicipioDialog({
  id,
  nome,
  observacoes,
  latitude,
  ...
  const [state, formAction, isPending] = useActionState(updateMunicipio, initialState);
